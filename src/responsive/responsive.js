const lightPurple = "rgb(151, 197, 252)";
const darkPurple = "rgb(67, 114, 171)";
var globalStorageId = null;
var globalStorageType = null;
...
$(document).ready(function() {
    ...
    getStorages().then(result => { //populate storage menu
        for (let i = 0; i < result["storageList"].length; i++) {
            ...
            $("#mainStorageLocation").append(newButtonString);
        }
        ...
        $(".squareBtn").each(function() {
            ...
            $(this).on("dblclick", function() {
                ...
                populateFileBrowser(globalStorageId, globalStorageType, "/")
            })
